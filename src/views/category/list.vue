<template>
  <div class="app-container">
    ...
    <div class="p20 bg_white">
      <div class="mb_10">
        <el-button type="primary" @click="handleView('')">添加</el-button>
      </div>
      <el-table v-loading="listLoading" :data="list" :height="tableHeight" row-key="id"
        ...
        <el-table-column label="海康上报小类" align="center" prop="send_time"></el-table-column>
        <el-table-column label="所属地市" align="center" prop="department_name"></el-table-column>
        <el-table-column label="启用状态" align="center" prop="status" :formatter="formatStatus">
          <template slot-scope="scope">
          <el-switch v-model="scope.row.value" active-color="#13ce66"  :active-value="1" :inactive-value="2"></el-switch>
          </template>
        </el-table-column>
        <el-table-column label="操作" align="center" min-width="160">
          <template slot-scope="scope">
            <el-button class="btn_blue02" type="primary" @click="handleView(scope.row)">编辑</el-button>
            <el-button @click="handleSmall">添加事件小类</el-button>
          </template>
        </el-table-column>
      </el-table>
